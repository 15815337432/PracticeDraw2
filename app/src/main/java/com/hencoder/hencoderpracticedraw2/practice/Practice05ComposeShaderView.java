...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader shaderA = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shaderB = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        paint.setShader(new ComposeShader(shaderA, shaderB, PorterDuff.Mode.DST_IN));
    }
