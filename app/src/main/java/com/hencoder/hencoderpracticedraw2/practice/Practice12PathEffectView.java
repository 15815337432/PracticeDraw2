...
public class Practice12PathEffectView extends View {
    ...
    Path path = new Path();
    private CornerPathEffect mCornerPathEffect = new CornerPathEffect(3);
    private DiscretePathEffect mDiscretePathEffect = new DiscretePathEffect(10, 2);
    private DashPathEffect mDashPathEffect = new DashPathEffect(new float[]{20, 5}, 1);
...

    {
        ...
        Path dashPath = new Path();
        //dashPath.arcTo(0, -20, 40, 0, 0, 179, true);
        dashPath.lineTo(20, -30);
        dashPath.lineTo(40, 0);
        dashPath.close();
        mPathDashPathEffect = new PathDashPathEffect(dashPath, 50, 100, PathDashPathEffect.Style.MORPH);
    }
