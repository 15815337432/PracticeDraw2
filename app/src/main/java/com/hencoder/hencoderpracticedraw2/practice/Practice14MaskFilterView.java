...
public class Practice14MaskFilterView extends View {
    ...
    private BlurMaskFilter mBlurMaskFilter2 = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    private BlurMaskFilter mBlurMaskFilter3 = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    private BlurMaskFilter mBlurMaskFilter4 = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
